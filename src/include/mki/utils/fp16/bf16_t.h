...
namespace std {
template<>
struct hash<Mki::bfloat16> {
    size_t operator()(const Mki::bfloat16 &v) const
    {
...
template<>
class numeric_limits<Mki::bfloat16> {
public:
    ...
    static constexpr Mki::bfloat16 min()
    {
        return Mki::bfloat16::min_positive_normal();
    }
    static constexpr Mki::bfloat16 lowest()
    {
        return Mki::bfloat16::lowest();
    }
    static constexpr Mki::bfloat16 max()
    {
        return Mki::bfloat16::highest();
    }
    static constexpr Mki::bfloat16 epsilon()
    {
        return Mki::bfloat16::epsilon();
    }
    static constexpr Mki::bfloat16 round_error()
    {
        return Mki::bfloat16(0x3F00, Mki::bfloat16::from_bits());
    }
    static constexpr Mki::bfloat16 infinity()
    {
        return Mki::bfloat16(0x7F80, Mki::bfloat16::from_bits());
    }
    static constexpr Mki::bfloat16 quiet_NaN()
    {
        return Mki::bfloat16(Mki::bfloat16::NAN_VALUE, Mki::bfloat16::from_bits());
    }
    static constexpr Mki::bfloat16 signaling_NaN()
    {
        return Mki::bfloat16(0x7F80, Mki::bfloat16::from_bits());
    }
    static constexpr Mki::bfloat16 denorm_min()
    {
        return Mki::bfloat16(0x0001, Mki::bfloat16::from_bits());
    }
};
